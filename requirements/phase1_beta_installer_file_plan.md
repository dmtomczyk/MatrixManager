...
- mount/install release contents or use built image directly
- read `.env`
...
3. Should `app` image be built locally during install, or pulled from versioned tags later?
4. Should admin password be prompted or auto-generated by default?

## Current Recommendation
1. Prefer **profiles** if readable.
2. Use **named volume** for PostgreSQL.
3. For now, support **local build during install**; later move to published images.
4. Default to **prompt with auto-generate fallback**.
